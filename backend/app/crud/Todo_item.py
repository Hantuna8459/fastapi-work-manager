...
async def read_todo_item_by_id(session, todo_item_id: str) \
...
async def is_todo_item_exist(session, todo_item_id: str) \
        -> bool:
...
async def create_todo_item(session, todo_item: TodoItemCreateSchema, user_id: str) \
        -> TodoItemDeepSchema:
...
async def delete_todo_item(session, todo_item_id: str)\
        -> None:
